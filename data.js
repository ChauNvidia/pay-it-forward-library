...
const cohorts = [
  ...
  { year: 2012, donors: 0, goal: 10 },
  { year: 2013, donors: 0, goal: 10 },
...
// ----------------------------------------------------------
const biggestMove = {
  year: "GMS Friend", // real: most new donors this week (3, vs. 1 each for 2000/2009/2011)
  newDonorsThisWeek: 3
};
...
const lightCoordinates = [
  { x: 0.0730, y: 0.5607, cohort: 2001, index: 0, brightness: 0.99, active: true },
  { x: 0.0952, y: 0.5601, cohort: 2001, index: 1, brightness: 0.93, active: true },
  { x: 0.1150, y: 0.5601, cohort: 2001, index: 2, brightness: 0.93, active: true },
  { x: 0.1419, y: 0.5551, cohort: 2001, index: 3, brightness: 0.87, active: true },
  ...
  { x: 0.0968, y: 0.6017, cohort: 2002, index: 11, brightness: 0.87, active: true },
  { x: 0.1215, y: 0.6081, cohort: 2002, index: 12, brightness: 0.97, active: true },
  { x: 0.1412, y: 0.6000, cohort: 2002, index: 13, brightness: 0.86, active: true },
  { x: 0.1599, y: 0.5970, cohort: 2002, index: 14, brightness: 0.96, active: true },
  { x: 0.0726, y: 0.6190, cohort: 2002, index: 15, brightness: 0.89, active: true },
  { x: 0.0991, y: 0.6191, cohort: 2002, index: 16, brightness: 0.82, active: true },
  { x: 0.1152, y: 0.6198, cohort: 2002, index: 17, brightness: 0.90, active: true },
  ...
  { x: 0.0701, y: 0.6858, cohort: 2003, index: 20, brightness: 0.99, active: true },
  { x: 0.0975, y: 0.6832, cohort: 2003, index: 21, brightness: 0.86, active: true },
  { x: 0.1143, y: 0.6825, cohort: 2003, index: 22, brightness: 0.96, active: true },
  { x: 0.1370, y: 0.6885, cohort: 2003, index: 23, brightness: 0.90, active: true },
  ...
  { x: 0.0711, y: 0.8017, cohort: 2004, index: 30, brightness: 0.96, active: true },
  { x: 0.0941, y: 0.8021, cohort: 2004, index: 31, brightness: 0.83, active: true },
  { x: 0.1142, y: 0.8055, cohort: 2004, index: 32, brightness: 0.86, active: true },
  { x: 0.1404, y: 0.8030, cohort: 2004, index: 33, brightness: 0.90, active: true },
  { x: 0.1653, y: 0.8044, cohort: 2004, index: 34, brightness: 0.92, active: true },
  { x: 0.0764, y: 0.8265, cohort: 2004, index: 35, brightness: 0.85, active: true },
  { x: 0.0987, y: 0.8341, cohort: 2004, index: 36, brightness: 0.86, active: true },
  ...
  { x: 0.0697, y: 0.9531, cohort: 2005, index: 40, brightness: 0.86, active: true },
  { x: 0.0971, y: 0.9446, cohort: 2005, index: 41, brightness: 0.97, active: true },
  { x: 0.1183, y: 0.9450, cohort: 2005, index: 42, brightness: 0.85, active: true },
  { x: 0.1413, y: 0.9423, cohort: 2005, index: 43, brightness: 0.86, active: true },
  { x: 0.1621, y: 0.9517, cohort: 2005, index: 44, brightness: 0.93, active: true },
  ...
  { x: 0.2299, y: 0.5610, cohort: 2006, index: 50, brightness: 0.85, active: true },
  { x: 0.2467, y: 0.5542, cohort: 2006, index: 51, brightness: 0.98, active: true },
  { x: 0.2741, y: 0.5656, cohort: 2006, index: 52, brightness: 0.82, active: true },
  { x: 0.2956, y: 0.5598, cohort: 2006, index: 53, brightness: 0.95, active: true },
  ...
  { x: 0.2513, y: 0.5971, cohort: 2007, index: 61, brightness: 0.94, active: true },
  { x: 0.2764, y: 0.6067, cohort: 2007, index: 62, brightness: 0.95, active: true },
  { x: 0.2936, y: 0.6050, cohort: 2007, index: 63, brightness: 0.92, active: true },
  { x: 0.3161, y: 0.6062, cohort: 2007, index: 64, brightness: 0.84, active: true },
  { x: 0.2304, y: 0.6092, cohort: 2007, index: 65, brightness: 0.93, active: true },
  ...
  { x: 0.2536, y: 0.6858, cohort: 2008, index: 71, brightness: 0.94, active: true },
  { x: 0.2701, y: 0.6870, cohort: 2008, index: 72, brightness: 0.97, active: true },
  { x: 0.2979, y: 0.6924, cohort: 2008, index: 73, brightness: 0.89, active: true },
  ...
  { x: 0.2467, y: 0.8090, cohort: 2009, index: 81, brightness: 0.83, active: true },
  { x: 0.2742, y: 0.8054, cohort: 2009, index: 82, brightness: 0.88, active: true },
  { x: 0.2969, y: 0.7988, cohort: 2009, index: 83, brightness: 0.84, active: true },
  ...
  { x: 0.2301, y: 0.9436, cohort: 2010, index: 90, brightness: 0.87, active: true },
  { x: 0.2492, y: 0.9499, cohort: 2010, index: 91, brightness: 0.91, active: true },
  { x: 0.2734, y: 0.9506, cohort: 2010, index: 92, brightness: 0.89, active: true },
  { x: 0.2969, y: 0.9524, cohort: 2010, index: 93, brightness: 0.84, active: true },
  { x: 0.3200, y: 0.9502, cohort: 2010, index: 94, brightness: 0.84, active: true },
  ...
  { x: 0.7093, y: 0.5604, cohort: 2011, index: 101, brightness: 0.96, active: true },
  { x: 0.7261, y: 0.5649, cohort: 2011, index: 102, brightness: 0.97, active: true },
  ...
  { x: 0.6870, y: 0.5972, cohort: 2012, index: 110, brightness: 0.86, active: true },
  { x: 0.7057, y: 0.5996, cohort: 2012, index: 111, brightness: 0.95, active: true },
  { x: 0.7286, y: 0.6024, cohort: 2012, index: 112, brightness: 0.97, active: true },
  { x: 0.7500, y: 0.5999, cohort: 2012, index: 113, brightness: 0.89, active: true },
  ...
  { x: 0.6849, y: 0.6826, cohort: 2013, index: 120, brightness: 0.92, active: true },
  { x: 0.7048, y: 0.6933, cohort: 2013, index: 121, brightness: 0.99, active: true },
  { x: 0.7257, y: 0.6875, cohort: 2013, index: 122, brightness: 0.84, active: true },
  { x: 0.7490, y: 0.6916, cohort: 2013, index: 123, brightness: 0.98, active: true },
  { x: 0.7714, y: 0.6856, cohort: 2013, index: 124, brightness: 0.85, active: true },
  ...
  { x: 0.6814, y: 0.8009, cohort: 2014, index: 130, brightness: 0.92, active: true },
  { x: 0.7050, y: 0.8031, cohort: 2014, index: 131, brightness: 0.89, active: true },
  ...
  { x: 0.8389, y: 0.5654, cohort: 2016, index: 150, brightness: 0.90, active: true },
  { x: 0.8658, y: 0.5579, cohort: 2016, index: 151, brightness: 0.90, active: true },
  { x: 0.8851, y: 0.5592, cohort: 2016, index: 152, brightness: 0.93, active: true },
  { x: 0.9024, y: 0.5624, cohort: 2016, index: 153, brightness: 0.97, active: true },
  { x: 0.9250, y: 0.5594, cohort: 2016, index: 154, brightness: 0.95, active: true },
  ...
  { x: 0.8405, y: 0.6071, cohort: 2017, index: 160, brightness: 0.95, active: true },
  { x: 0.8659, y: 0.6059, cohort: 2017, index: 161, brightness: 0.89, active: true },
  { x: 0.8882, y: 0.6067, cohort: 2017, index: 162, brightness: 0.95, active: true },
  ...
  { x: 0.8441, y: 0.6910, cohort: 2018, index: 170, brightness: 1.00, active: true },
  { x: 0.8599, y: 0.6892, cohort: 2018, index: 171, brightness: 0.95, active: true },
  { x: 0.8831, y: 0.6866, cohort: 2018, index: 172, brightness: 0.83, active: true },
  { x: 0.9038, y: 0.6863, cohort: 2018, index: 173, brightness: 0.84, active: true },
  ...
  { x: 0.8433, y: 0.7993, cohort: 2019, index: 180, brightness: 0.99, active: true },
  { x: 0.8631, y: 0.8049, cohort: 2019, index: 181, brightness: 0.93, active: true },
  { x: 0.8839, y: 0.8020, cohort: 2019, index: 182, brightness: 0.94, active: true },
  { x: 0.9068, y: 0.8020, cohort: 2019, index: 183, brightness: 0.95, active: true },
  ...
  { x: 0.8426, y: 0.9527, cohort: 2020, index: 190, brightness: 0.95, active: true },
  { x: 0.8635, y: 0.9532, cohort: 2020, index: 191, brightness: 0.97, active: true },
  { x: 0.8858, y: 0.9429, cohort: 2020, index: 192, brightness: 0.93, active: true },
